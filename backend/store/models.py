...
#     image = models.ImageField(upload_to="test", default="category.jpg", null=True, blank=True)
...
#     title = models.CharField(max_length=100)
#     # Image for the brand
#     image = models.ImageField(upload_to="test", default="brand.jpg", null=True, blank=True)
#     # Is the brand active?
#     active = models.BooleanField(default=True)
...
#     image = models.FileField(upload_to="test", blank=True, null=True, default="product.jpg")
...
#     image = models.FileField(upload_to="test", default="gallery.jpg")
#     # Is the image active?
#     active = models.BooleanField(default=True)
